...
const AboutUs = () => {
  ...
  return (
    <div
      ref={containerRef}
      id="about"
      className="container mx-auto -mt-14 flex flex-col items-center justify-center space-y-4 bg-[url(/stars_arrows_mobile.svg)] bg-contain bg-center bg-no-repeat px-2 pt-14 text-black sm:space-y-8 sm:bg-[url(/stars_arrows.svg)] md:space-y-10 md:bg-cover lg:space-y-14"
    >
